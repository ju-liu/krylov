...
class _Projection(utils.Projection):
    def __init__(self, linear_system, U, **kwargs):
        ...
        :param A: the :py:class:`~krylov.linsys.LinearSystem`.
        :param U: basis of the deflation space with ``U.shape == (N, d)``.

        All parameters of :py:class:`~krylov.utils.Projection` are valid except
        ``X`` and ``Y``.
        """
...
class _DeflationMixin(object):
    ...
    :py:mod:`~krylov.linsys`.

    :param linear_system: the :py:class:`~krylov.linsys.LinearSystem` that
      should be solved.
    ...
    def estimate_time(self, nsteps, ndefl, deflweight=1.0):
        ...
        :py:class:`~krylov.linsys.TimedLinearSystem`. Otherwise, an
        :py:class:`~krylov.utils.OtherError`
        is raised.
...
class DeflatedCg(_DeflationMixin, linsys.Cg):
    ...
    See :py:class:`_DeflationMixin` and :py:class:`~krylov.linsys.Cg` for
...
class DeflatedMinres(_DeflationMixin, linsys.Minres):
    ...
    See :py:class:`_DeflationMixin` and :py:class:`~krylov.linsys.Minres` for
    the documentation of the available parameters.
    """
...
class DeflatedGmres(_DeflationMixin, linsys.Gmres):
    ...
    See :py:class:`_DeflationMixin` and :py:class:`~krylov.linsys.Gmres` for
    the documentation of the available parameters.
    """
...
def bound_pseudo(
    ...
    :param arnoldifyer: an instance of
      :py:class:`~krylov.deflation.Arnoldifyer`.
